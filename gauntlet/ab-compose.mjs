...
const bar = process.argv[4] || 'gauntlet/shots-r4/r5-bar.png'
...
await sharp({create:{width:2560,height:800,channels:3,background:{r:17,g:17,b:17}}})
  ...
  .png().toFile(`gauntlet/shots-r4/r${round}-ab.png`)
copyFileSync(bar, `gauntlet/shots-r4/r${round}-bar.png`)
console.log('ab', statSync(`gauntlet/shots-r4/r${round}-ab.png`).size)
